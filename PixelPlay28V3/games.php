...
if (isset($_GET["category"])) {
    $categoryFilter = " WHERE category = '{$_GET["category"]}'";
}

if (isset($_GET["price-range"])) {
    $operator = isset($_GET["category"]) ? ' AND ' : ' WHERE ';
...
$rows = $db->query($query . $categoryFilter . $priceRangeFilter);
...
<script src="filtersscript.js"></script>
